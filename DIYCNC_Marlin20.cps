...
function writeFirstSection() {
  ...
  writeln("");
  writeActivityComment(" *** START begin ***" + properties.gcodeStartFile);
...
function protectedProbeMove(_cycle, x, y, z) {
  writeComment("*** protectedProbeMove: " + _cycle + ":" + x + "," + y + "," + z) ;
...
function onCyclePoint(x, y, z) {
  ...
  writeComment(JSON.stringify(cycle));
  writeComment("tool diameter:" + tool.diameter);
...
//      protectedProbeMove(cycle, x, y, z - cycle.depth);
  ...
  writeComment("*** onCyclePoint done *** ") ;
